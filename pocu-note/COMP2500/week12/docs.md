...
![img.png](pocu-note/COMP2500/week12/images/img.png)

- 일단 기본기 다지쇼
- 내 코드가 정확히 도는지 이해할 때 까지
- 패턴을 보는 순간 새롭지 않아야함

![img_1.png](pocu-note/COMP2500/week12/images/img_1.png)

![img_2.png](pocu-note/COMP2500/week12/images/img_2.png)

## 팩토리 메서드 패턴

![img_3.png](pocu-note/COMP2500/week12/images/img_3.png)

![img_4.png](pocu-note/COMP2500/week12/images/img_4.png)

- static 매서드 `createOrNull()` 을 통해서만 개체 생성 가능
    - 생성자 private

![img_5.png](pocu-note/COMP2500/week12/images/img_5.png)

![img_6.png](pocu-note/COMP2500/week12/images/img_6.png)

- 생성자 대신 정적 팩토리 매서드를 사용하면 장점은 null 반환 가능

![img_7.png](pocu-note/COMP2500/week12/images/img_7.png)

### 확장 1

![img_8.png](pocu-note/COMP2500/week12/images/img_8.png)

![img_9.png](pocu-note/COMP2500/week12/images/img_9.png)

- 매개변수로 처리하기보다 다형성을 이용하는게 OO 적인 사고방식

![img_10.png](pocu-note/COMP2500/week12/images/img_10.png)

- static 매서드는 다형적으로 구현할 수 없음
    - 클래스 마다 지정되는 개념
    - 사실 전역함수를 클래스 내부에 감싸놓은게 전부

![img_11.png](pocu-note/COMP2500/week12/images/img_11.png)
...
![img_12.png](pocu-note/COMP2500/week12/images/img_12.png)

![img_13.png](pocu-note/COMP2500/week12/images/img_13.png)
...
![img_14.png](pocu-note/COMP2500/week12/images/img_14.png)

![img_15.png](pocu-note/COMP2500/week12/images/img_15.png)

![img_16.png](pocu-note/COMP2500/week12/images/img_16.png)

### 확장 2

![img_17.png](pocu-note/COMP2500/week12/images/img_17.png)

- Cup 클래스도 일반화
- 한국에서는 일회용 컵 쓰고, 미국은 종이컵 쓰고...

![img_18.png](pocu-note/COMP2500/week12/images/img_18.png)
...
![img_19.png](pocu-note/COMP2500/week12/images/img_19.png)

![img_20.png](pocu-note/COMP2500/week12/images/img_20.png)

![img_21.png](pocu-note/COMP2500/week12/images/img_21.png)

![img_22.png](pocu-note/COMP2500/week12/images/img_22.png)

![img_23.png](pocu-note/COMP2500/week12/images/img_23.png)

![img_24.png](pocu-note/COMP2500/week12/images/img_24.png)

![img_25.png](pocu-note/COMP2500/week12/images/img_25.png)

![img_26.png](pocu-note/COMP2500/week12/images/img_26.png)
...
![img_27.png](pocu-note/COMP2500/week12/images/img_27.png)

- 벽돌을 쌓아서 완성하는 느낌

### 다형성 없는 빌더 패턴

![img_28.png](pocu-note/COMP2500/week12/images/img_28.png)

![img_29.png](pocu-note/COMP2500/week12/images/img_29.png)

- 문자열 더하기 성능 문제

![img_30.png](pocu-note/COMP2500/week12/images/img_30.png)

![img_31.png](pocu-note/COMP2500/week12/images/img_31.png)

![img_32.png](pocu-note/COMP2500/week12/images/img_32.png)

- 오버로딩 때문에 편함

![img_33.png](pocu-note/COMP2500/week12/images/img_33.png)

- 내부적으로 빌더에서 충분히 미리 용량 잡아서 성능에 유리
    - OO에서 이 내부 공개 안 하는게 추상화, 캡슐화

![img_34.png](pocu-note/COMP2500/week12/images/img_34.png)

### 플루언트 인터페이스

![img_35.png](pocu-note/COMP2500/week12/images/img_35.png)

- appendLine 매서드가 있으면 좋을 것 같은데..

![img_36.png](pocu-note/COMP2500/week12/images/img_36.png)

- 요즘 새로 생긴 패턴

![img_37.png](pocu-note/COMP2500/week12/images/img_37.png)

- 세미콜론 안 찍고 .으로 계속 호출
- 한 줄에 처리하는 것을 명확하게 보여줄 수 있음

![img_38.png](pocu-note/COMP2500/week12/images/img_38.png)

![img_39.png](pocu-note/COMP2500/week12/images/img_39.png)

- 자기 자신을 반환하기 때문에 플루언트 인터페이스 가능

![img_40.png](pocu-note/COMP2500/week12/images/img_40.png)

- this 반환하는거 보셈

![img_41.png](pocu-note/COMP2500/week12/images/img_41.png)
...
![img_42.png](pocu-note/COMP2500/week12/images/img_42.png)

![img_43.png](pocu-note/COMP2500/week12/images/img_43.png)

![img_44.png](pocu-note/COMP2500/week12/images/img_44.png)

- robert 나이가 1인데?

![img_45.png](pocu-note/COMP2500/week12/images/img_45.png)

![img_46.png](pocu-note/COMP2500/week12/images/img_46.png)

- 이건 컴파일러가 못잡죠

![img_47.png](pocu-note/COMP2500/week12/images/img_47.png)

- 그래서 매서드를 빌더 패턴으로 각각 따로 만들면?
- 매서드 명으로 실수할 여지를 줄임
- 근데 이건 잘못된 해결법임

![img_48.png](pocu-note/COMP2500/week12/images/img_48.png)

- StartYear 초기화는 없누

![img_49.png](pocu-note/COMP2500/week12/images/img_49.png)

- Int 초기값인 0으로 설정
- 개체 생성 시 개체의 상태가 유효해야 한다는 캡슐화에 문제가 생김
    - 생성자를 사용

![img_50.png](pocu-note/COMP2500/week12/images/img_50.png)

- StringBuilder 은 올바르게 빌더 패턴을 구현함

### 빌더 패턴 실수 막기

![img_51.png](pocu-note/COMP2500/week12/images/img_51.png)
...
![img_52.png](pocu-note/COMP2500/week12/images/img_52.png)

- 완벽한 방법은 아님

![img_53.png](pocu-note/COMP2500/week12/images/img_53.png)

- named parameter

![img_54.png](pocu-note/COMP2500/week12/images/img_54.png)

![img_55.png](pocu-note/COMP2500/week12/images/img_55.png)

- 코틀린에도 이거 활용하면 좋죠
    - 최근 언어는 거의 있음

![img_56.png](pocu-note/COMP2500/week12/images/img_56.png)

- 디자인 패턴의 많은 것은 언어에서 자체 지원이 있다면 사용할 필요 없다는 명제를 보충하는 사례

### 다형적 빌더 패턴

![img_57.png](pocu-note/COMP2500/week12/images/img_57.png)

- 다형적으로 HTML, markdown 포맷을 사용할 예정

![img_58.png](pocu-note/COMP2500/week12/images/img_58.png)

![img_59.png](pocu-note/COMP2500/week12/images/img_59.png)

![img_60.png](pocu-note/COMP2500/week12/images/img_60.png)

- TableBuilder 추상 클래스
    - 말 그대로 테이블을 만드는 추상 매서드를 가지고 있음

![img_61.png](pocu-note/COMP2500/week12/images/img_61.png)

- builder 다형적으로 `writeTo()` 매소드에 인자로 넘김

![img_62.png](pocu-note/COMP2500/week12/images/img_62.png)

![img_63.png](pocu-note/COMP2500/week12/images/img_63.png)

![img_64.png](pocu-note/COMP2500/week12/images/img_64.png)

- `addHeadingRow()` 매소드 결과 첫줄의 토큰을 읽어서 `<th>` 나 markdown 헤더로 변경

![img_65.png](pocu-note/COMP2500/week12/images/img_65.png)

![img_66.png](pocu-note/COMP2500/week12/images/img_66.png)
...
![img_67.png](pocu-note/COMP2500/week12/images/img_67.png)

- 동작을 시간의 흐름에 따라 보여줌

![img_68.png](pocu-note/COMP2500/week12/images/img_68.png)

- 참여자 == 개체

![img_69.png](pocu-note/COMP2500/week12/images/img_69.png)

- 개체의 삶을 보여주는 수명선

![img_70.png](pocu-note/COMP2500/week12/images/img_70.png)

- 활성화는 함수 호출 후 실행하는 기간이라고 생각하면 편함

![img_71.png](pocu-note/COMP2500/week12/images/img_71.png)

- 함수 호출로 이해하는게 편함

![img_72.png](pocu-note/COMP2500/week12/images/img_72.png)

- new 로 호출할 때 사용

![img_73.png](pocu-note/COMP2500/week12/images/img_73.png)

![img_74.png](pocu-note/COMP2500/week12/images/img_74.png)

![img_75.png](pocu-note/COMP2500/week12/images/img_75.png)

![img_76.png](pocu-note/COMP2500/week12/images/img_76.png)
...
![img_77.png](pocu-note/COMP2500/week12/images/img_77.png)

- 클래스로 감싸는 식으로 구현
- 클래스 코드 자체를 수정하지 못하지만, 래퍼 클래스로 감싸서 커스터마이징 할 수 있음
    - 보통 남의 라이브러리 사용할 때

![img_78.png](pocu-note/COMP2500/week12/images/img_78.png)

![img_79.png](pocu-note/COMP2500/week12/images/img_79.png)

- 어댑터를 씌운다고 생각해도 됨

![img_80.png](pocu-note/COMP2500/week12/images/img_80.png)
...
![img_81.png](pocu-note/COMP2500/week12/images/img_81.png)

![img_82.png](pocu-note/COMP2500/week12/images/img_82.png)

- 매서드 시그니처가 각각 다르다
    - 함수 이름
    - 매개변수 목록

![img_83.png](pocu-note/COMP2500/week12/images/img_83.png)

- 값의 유효한 범위도 자료형에 따라 다름

![img_84.png](pocu-note/COMP2500/week12/images/img_84.png)

- 일단 원래 코드에서 OpenGL 을 사용했다고 가정해보자

![img_85.png](pocu-note/COMP2500/week12/images/img_85.png)

- DirectX로 바꾸기로 결정하면 고칠게 많음

![img_86.png](pocu-note/COMP2500/week12/images/img_86.png)

- 래퍼 패턴을 사용해보자
- clear 라는 매서드를 만들고 이 매서드 시그니처만 사용하게

![img_87.png](pocu-note/COMP2500/week12/images/img_87.png)

- 래퍼 클래스인 Graphics 클래스의 내부에서 OpenGL 개체를 사용

![img_88.png](pocu-note/COMP2500/week12/images/img_88.png)

![img_89.png](pocu-note/COMP2500/week12/images/img_89.png)

- 딱 이 Graphics 클래스 내부 코드 구현만 바꾸면 됨
- 어댑터만 수정한다고 생각해도 됨
- 클라이언트 코드를 바꾸지 않아도 되는 것이 핵심!!!

![img_90.png](pocu-note/COMP2500/week12/images/img_90.png)

### 래퍼 패턴: DTO

![img_91.png](pocu-note/COMP2500/week12/images/img_91.png)

![img_92.png](pocu-note/COMP2500/week12/images/img_92.png)

- 굉장히 익숙하네요

![img_93.png](pocu-note/COMP2500/week12/images/img_93.png)

- 필요 이상의 데이터를 반환하지 말자

![img_94.png](pocu-note/COMP2500/week12/images/img_94.png)

![img_95.png](pocu-note/COMP2500/week12/images/img_95.png)

![img_96.png](pocu-note/COMP2500/week12/images/img_96.png)

- `toDto()` 매서드 만들어서 변환해서 반환

![img_97.png](pocu-note/COMP2500/week12/images/img_97.png)

![img_98.png](pocu-note/COMP2500/week12/images/img_98.png)

## 프록시 패턴

![img_99.png](pocu-note/COMP2500/week12/images/img_99.png)

- 프록시
- 캐시 메모리처럼 작동함

![img_100.png](pocu-note/COMP2500/week12/images/img_100.png)
![img_101.png](pocu-note/COMP2500/week12/images/img_101.png)
...
![img_102.png](pocu-note/COMP2500/week12/images/img_102.png)
...
![img_103.png](pocu-note/COMP2500/week12/images/img_103.png)

- 프록시 패턴을 사용하지 않은 예

![img_104.png](pocu-note/COMP2500/week12/images/img_104.png)

- 위에서 말한 값 비싼 리소스를 다룰 때 생기는 문제 발생

![img_105.png](pocu-note/COMP2500/week12/images/img_105.png)

- 그리고 과연 모든 이미지를 사용할까?
    - 괜히 필요없는데 다 로딩하는게 아닐까?

![img_106.png](pocu-note/COMP2500/week12/images/img_106.png)

![img_117.png](pocu-note/COMP2500/week12/images/img_117.png)
...
![img_107.png](pocu-note/COMP2500/week12/images/img_107.png)
...
![img_108.png](pocu-note/COMP2500/week12/images/img_108.png)
...
![img_109.png](pocu-note/COMP2500/week12/images/img_109.png)

- 프록시 패턴의 문제는 내부를 알기 어려움
    - 병목점
    - 메모리 사용량

![img_110.png](pocu-note/COMP2500/week12/images/img_110.png)

- 캡슐화에 따르면 사용하면 로딩 방법 3가지 등 어떤 구현인지 클라이언트는 알 필요가 없음
- 근데 이게 꼭 좋은건가?
    - 사용자의 편의성을 생각해보자

![img_111.png](pocu-note/COMP2500/week12/images/img_111.png)

- 요즘은 내부 동작을 보여주는 방식이 더 많이 사용됨
- 거의 이렇죠?

![img_112.png](pocu-note/COMP2500/week12/images/img_112.png)

![img_113.png](pocu-note/COMP2500/week12/images/img_113.png)
...
![img_114.png](pocu-note/COMP2500/week12/images/img_114.png)

- 새로 추가한 멤버 함수는 클라이언트를 위함
- 클라이언트는 로딩 상태를 확인하고, 로딩도 직접 제어할 수 있음
    - 이런 방식을 상태에 따라 개체를 사용하는 방식을 상태머신이라고 부름

![img_115.png](pocu-note/COMP2500/week12/images/img_115.png)
...
![img_116.png](pocu-note/COMP2500/week12/images/img_116.png)
...
![img_118.png](pocu-note/COMP2500/week12/images/img_118.png)

- 위키피디아 예시

![img_119.png](pocu-note/COMP2500/week12/images/img_119.png)

![img_120.png](pocu-note/COMP2500/week12/images/img_120.png)

- Logger 클래스는 추상 클래스로 일반화됨
- 멤버변수로 Logger 타입의 next

![img_121.png](pocu-note/COMP2500/week12/images/img_121.png)
...
![img_122.png](pocu-note/COMP2500/week12/images/img_122.png)

- 콘솔 창에 출력하는 자식 클래스

![img_123.png](pocu-note/COMP2500/week12/images/img_123.png)

- 이메일

![img_124.png](pocu-note/COMP2500/week12/images/img_124.png)

- 파일

![img_125.png](pocu-note/COMP2500/week12/images/img_125.png)

- enum 코드에서 values() 라는 함수 호출하면 enum의 멤버를 배열로 반환함

![img_126.png](pocu-note/COMP2500/week12/images/img_126.png)

- setNext 함수를 연쇄로 호출해서 다음의 다음의 설정...
- 아래 코드들은 로그 레벨이 달라지고 호출되는 예시
    - message 함수에서 logLevels.contains(severity) 때문에 필터링

![img_127.png](pocu-note/COMP2500/week12/images/img_127.png)

![img_128.png](pocu-note/COMP2500/week12/images/img_128.png)

- ConsoleLogger 개체 참조를 대입한 변수 logger 하나만 사용하면 됨

![img_129.png](pocu-note/COMP2500/week12/images/img_129.png)

![img_130.png](pocu-note/COMP2500/week12/images/img_130.png)
...
![img_131.png](pocu-note/COMP2500/week12/images/img_131.png)

- LoggerManager 클래스로 관리하면 다형적으로 매서드 호출 가능한데?

![img_132.png](pocu-note/COMP2500/week12/images/img_132.png)

- 가지고 있는 모든 Logger 클래스에서 다형적으로 message 매서드 호출

![img_133.png](pocu-note/COMP2500/week12/images/img_133.png)

- 이제 Logger 클래스에서 next 멤버 변수 사라짐

![img_134.png](pocu-note/COMP2500/week12/images/img_134.png)

![img_135.png](pocu-note/COMP2500/week12/images/img_135.png)

![img_136.png](pocu-note/COMP2500/week12/images/img_136.png)

- Logger 클래스를 상속받는 자식 클래스들은 변한게 없음

![img_137.png](pocu-note/COMP2500/week12/images/img_137.png)
...
![img_138.png](pocu-note/COMP2500/week12/images/img_138.png)

- 위키의 예가 잘못됨

![img_139.png](pocu-note/COMP2500/week12/images/img_139.png)

- next 멤버 변수는 "책임"을 위해 필요함

![img_140.png](pocu-note/COMP2500/week12/images/img_140.png)
...
![img_141.png](pocu-note/COMP2500/week12/images/img_141.png)

- 조건문으로 첫번째 예를 수정하면 됨

![img_142.png](pocu-note/COMP2500/week12/images/img_142.png)

- alt 는 선택지를 의미함

## 옵저버 패턴 == pub-sub pattern

![img_143.png](pocu-note/COMP2500/week12/images/img_143.png)

![img_144.png](pocu-note/COMP2500/week12/images/img_144.png)

- 감시해서 개체의 변화를 감지

![img_145.png](pocu-note/COMP2500/week12/images/img_145.png)

- 감시자는 여러 개일 수 있음
- 감시 대상은 한 개

![img_146.png](pocu-note/COMP2500/week12/images/img_146.png)

- 감시 대상이 변하면 감시자들은 뭔가 행동을 함

![img_147.png](pocu-note/COMP2500/week12/images/img_147.png)

- 요즘은 사실상 pub-sub 패턴으로 부름
    - pub-sub 패턴이 사실 옵저버 패턴을 포함하는 더 넓은 개념임

![img_148.png](pocu-note/COMP2500/week12/images/img_148.png)
...
![img_149.png](pocu-note/COMP2500/week12/images/img_149.png)

- LogManager 개체만 사라지면 옵저버 패턴

### 옵저버 패턴 예시: 크라우드 펀딩

![img_150.png](pocu-note/COMP2500/week12/images/img_150.png)

![img_151.png](pocu-note/COMP2500/week12/images/img_151.png)

![img_152.png](pocu-note/COMP2500/week12/images/img_152.png)

- 푸시 알람
- event-driven architecture

![img_153.png](pocu-note/COMP2500/week12/images/img_153.png)

![img_154.png](pocu-note/COMP2500/week12/images/img_154.png)

![img_155.png](pocu-note/COMP2500/week12/images/img_155.png)

![img_156.png](pocu-note/COMP2500/week12/images/img_156.png)
...
![img_157.png](pocu-note/COMP2500/week12/images/img_157.png)
...
![img_158.png](pocu-note/COMP2500/week12/images/img_158.png)
...
![img_159.png](pocu-note/COMP2500/week12/images/img_159.png)

- JVM 에서 여전히 사용중으로 인식함
- 조율하는 클래스 CrowdFundingAccount 에서 여전히 참조를 가지고 있기 때문

![img_160.png](pocu-note/COMP2500/week12/images/img_160.png)

- 해결법은 unsubscribe() 함수 만들어서 직접 subscribers 에서 제거

![img_161.png](pocu-note/COMP2500/week12/images/img_161.png)

- 이거 안 까먹고 할 자신있냐?
- 이벤트 핸들러로 등록한 것들 다 찾아서 제거해줘야하는데..?

![img_162.png](pocu-note/COMP2500/week12/images/img_162.png)
