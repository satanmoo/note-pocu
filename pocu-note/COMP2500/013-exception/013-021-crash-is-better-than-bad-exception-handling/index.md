...
이전 강의에서 본 것처럼 예외를 처리하다 오히려 더 잘못될 수 있음 ^bad-handling-makes-it-worse
...
디버깅에는 크래시가 더 유리함 ^crash-better-for-debugging
- 메모리 덤프
...
메모리 덤프는 예외보다 정보가 많음 ^memory-dump-richer
